...
<!-- СОЗДАНИЕ -->
  <form action="/php/admin_actions/create_user.php" method="post">
  <th>Создание новой учетной записи</th><th></th>
  <tr>
  <td>Введите имя:</td><td><input type="text" name="username" placeholder="Логин" /></td> 
  </tr>
  <tr>
  <td>Введите пароль:</td><td><input type="password" name="pwd" placeholder="Пароль" /></td> 
  </tr>
  <tr>
  <td>Введите почту: </td><td><input type="text" name="email" placeholder="Почта" ></td> 
  </tr>
  <tr>
  <td class="form-inline">Выберете уровень привелегий: </td><td><select name="user_type" lass="form-control">
  ...
  <tr>
  <td><input type="submit" value="Создать" class="btn btn-warning btn-block btn-sm"></td><td><button type="reset" class="btn btn-warning btn-block btn-sm">Очистить форму</button></td> 
  </tr>
  <th>
      <?php
      check_create_errors();
...
<!-- ОБНОВЛЕНИЕ -->
  ...
  <form action="/php/admin_actions/update_user.php" method="post">
  <th>Обновить данные уже зарегестрированного пользователя:</th><th></th>
  <tr>
  <td>Введите ID пользователя, данные которого хотите обновить:</td><td><input type="number" name="user_id" placeholder="Идентификатор" /></td> 
  </tr>
  <tr>
  <td>Введите НОВОЕ имя:</td><td><input type="text" name="username" placeholder="Логин" /></td> 
  </tr>
  <tr>
  <td>Введите НОВЫЙ пароль:</td><td><input type="password" name="pwd" placeholder="Пароль" /></td> 
  </tr>
  <tr>
  <td>Введите НОВУЮ почту: </td><td><input type="text" name="email" placeholder="Почта" ></td> 
  </tr>
  <tr>
  <td class="form-inline">Выберете НОВЫЙ уровень привелегий:  </td><td><select name="user_type" lass="form-control">
  ...
  <tr>
  <td><input type="submit" value="Обновить" class="btn btn-warning btn-block btn-sm"></td><td><button type="reset" class="btn btn-warning btn-block btn-sm">Очистить форму</button></td> 
  </tr>
  </form>
  <tr>
    <th>
      <span class="error_style"> <?php
      check_update_errors();
      ?></span>
     </th>
  </tr>
...
<!-- ПРОСМОТР ДАННЫХ-->
<tr>
<td>Просмотреть информацию об уже существующих пользователях:</td>
<form action="/php/admin_actions/info_users.php" method="post">
...
<!-- ПРОСМОТР КОММЕНТОВ-->
<tr>
<td>Просмотреть все комментарии:</td>
<form action="/php/admin_actions/info_comments_all.php" method="post">
...
<th>Удаление учетность запись</th><th></th>
<form action="/php/admin_actions/delete_user.php" method="post">
<tr>
<td><label for="search">Введите ID пользователя: </label></td>
<td><input id="search" type="text" name="user_search_delete" placeholder="Идентификатор"></td>
</tr>
<tr>
<td></td>
<td><button class="btn btn-warning btn-block btn-sm">Удалить</button></td>
</tr>
<tr>
<th><?php
check_delete_errors();
...
<!-- АКТИВАЦИЯ -->
<th>Активировать учетную запись</th><th></th>
<form action="/php/admin_actions/activation_user.php" method="post">
<tr>
<td><label for="search">Введите ID или Имя пользователя:</label></td>
<td> <input id="search" type="text" name="user_activation" placeholder="Идентификатор | Имя"></td>
</tr>
<tr>
<td></td>
<td><button class="btn btn-warning btn-block btn-sm">Активировать</button></td>
</tr>
</form>
<tr>
<th><?php
...
<th>Отключить учетную запись</th><th></th>
<form action="/php/admin_actions/deactivation_user.php" method="post">
<tr>
<td><label for="search">Введите ID или Имя пользователя:</label></td>
<td> <input id="search" type="text" name="user_deactivation" placeholder="Идентификатор | Имя"></td>
</tr>
<tr>
<td></td>
<td><button class="btn btn-warning btn-block btn-sm">Отключить</button></td>
</tr>
</form>
<tr>
<th><?php
...
<!-- НАПИСАНИЕ КОМЕНТА -->
<form action="/php/admin_actions/write_comment.php" method="post">
  <th>Написать комментарий от имени пользователя:</th><th></th>
  <tr>
  <td>Введите Имя пользователя или ID:</td><td><input type="text" name="userID" placeholder="Идентификатор | Имя" /></td> 
  </tr>
  <tr>
...
<form action="/php/admin_actions/search_comments_post.php" method="post"> 
<tr>
...
<form action="/php/admin_actions/search_comments_ban.php" method="post">   
<tr>
<td><label for="search">Введите Имя или ID пользователя, комментарии которого хотите просмотреть:</label></td>
<td> <input type="text" name="userSearch" placeholder="Идентификатор | Имя" /></td>
</tr>
...
<form action="/php/admin_actions/comment_post.php" method="post"> 
<tr>
...
<form action="/php/admin_actions/comment_ban.php" method="post">
<tr>
...
<!-- Опубликовать ВСЕ комментарии пользователя::-->
<th>Опубликовать ВСЕ комментарии пользователя:</th><th></th>
<form action="/php/admin_actions/all_comments_post.php" method="post">   
<tr>
<td><label for="search2">Введите Имя или Идентификатор пользователя:</label></td>
<td>  <input id="search2" type="text" name="username" placeholder="Идентификатор | Имя"></td>
</tr>
<tr>
<td></td>
<td><button class="btn btn-warning btn-block btn-sm">Опубликовать все</button></td>
</tr>
<tr>
<th><?php
...
<th>Скрыть ВСЕ комментарии пользователя:</th><th></th>
<form action="/php/admin_actions/all_comments_ban.php" method="post">    
<tr>
<td><label for="search2">Введите Имя или Идентификатор пользователя:</label></td>
<td>  <input id="search2" type="text" name="username" placeholder="Идентификатор | Имя"></td>
</tr>
<tr>
<td></td>
<td><button class="btn btn-warning btn-block btn-sm">Скрыть все</button></td>
</tr>
<tr>
<th><?php
...
<form action="/php/admin_actions/send_email.php" method="post">
  <th>Написать ПИСЬМО от имени одного пользователя другому пользователю:</th><th></th>
  <tr>
  <td>От кого: </td><td><input type="text" name="email_from" placeholder="Адрес почты" /></td> 
  </tr>
  <tr>
...
<th>Поиск ОТПРАВЛЕННЫХ пользователем писем:</th><th></th>
<form action="/php/admin_actions/search_email_send.php" method="post">        
<tr>
<td>Введите Имя или ID пользователя, письма которого хотите просмотреть:</td>
<td><input type="text" name="userSearch" placeholder="Идентификатор | Имя" /></td>
</tr>
<tr>
<td></td>
<td><input type="submit" value="Искать" class="btn btn-warning btn-block btn-sm"></td>
</tr>
<tr>
<th><?php
...
<!--Поиск ПОЛУЧЕННЫХ пользователем писем-->
<th>Поиск ПОЛУЧЕННЫХ пользователем писем</th><th></th>
<form action="/php/admin_actions/search_email_received.php" method="post">        
<tr>
<td>Введите Имя или ID пользователя, письма которого хотите просмотреть:</td>
<td><input type="text" name="userSearch" placeholder="Идентификатор | Имя" /></td>
</tr>
                ...
                <div class="card-body">
                  ...
                  <div class="pictureUpload">
                    ...
                    <div id="pictureList">
                      ...
                      <img src="/img/img_profile/admin.png" height="314" class='img-fluid'  />
                      <br />
                    </div>
