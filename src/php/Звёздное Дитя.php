...
<head>
 ...
 <meta name="keywords" content="Звездное дитя, новый сезон, выход аниме, анимэ ребенок айдола, 2024 год"/>
  

  <title>Новый сезон Зведного дитя</title>
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          ...
          <div class="main_blog_details">
              ...
              <a href="#"><h4>Анонс 2 сезон аниме-сериала «Oshi no Ko»</h4></a>
              ...
              <p class="otstup"  id="root">Анонсировали второй сезон аниме-адаптации манги «Звёздное Дитя». Пока без подробностей.</p>
              <p class="otstup"  id="root">Ложь — это оружие в индустрии шоу-бизнеса.</p>
              <img class="img-fluid" src="/img/blog/idol.jpg" alt="">
              <p class="otstup"  id="root">Врач по имени Горо и не подозревал, что однажды станет лечить артиста, от которого давно в восторге. Когда к нему в пациенты попала беременная шестнадцатилетняя Ай Хосино, он был и счастлив, и обеспокоен:
                 слишком уж ответственным было порученное ему дело, да еще и совершалось оно в тайне ото всех, кроме продюсера самой девушки... В итоге парень так и не успел принять роды у Ай: его самого убил другой фанат, через несколько лет прикончивший
                  и Хосино. Однако Горо, пройдя реинкарнацию, попал в тело новорожденного ребенка своей обожаемой артистки. Сохранив память, он любил ее с той же фанатской преданностью до самой гибели Ай вместе с ее же убийцей...
                 А после решил найти того, кто "заказал" и доктора, и его пациентку. Детективная драма в новой жизни Горо вовсе не закончилась; что ждет его впереди?.</p>



                 <!-- <div class="youtube1"></div> -->
                 <!-- <iframe width="730" 
  height="411" src="https://www.youtube.com/embed/Cxfr5hENj54?si=8QzTeI3OfoRx1xDY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
 -->
 ...
 <figure class="wp-block-embed">
  ...
  height="411" src="https://www.youtube.com/embed/Cxfr5hENj54?si=8QzTeI3OfoRx1xDY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
         ...
         <div class="news_d_footer flex-column flex-sm-row">
               <a href="#"><span class="align-middle mr-2"><i class="ti-heart"></i></span>6 человек оценили эту статью</a>
