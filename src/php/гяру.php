...
<head>
 ...
 <meta name="keywords" content="новое аниме, анонс анимэ, адаптация манги, Dosanko Gal wa Namara Menkoi, премьера"/>
  


  <title>Дата премьеры «Dosanko Gal wa Namara Menkoi»</title>
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          ...
          <div class="main_blog_details">
              ...
              <a href="#"><h4>Дата премьеры «Dosanko Gal wa Namara Menkoi»</h4></a>
              ...
              <p class="otstup"  id="root">Официальный твиттер аниме «Досанко-гяру чудо как милы» представил первый трейлер, новый постер, актёрский состав и объявил месяц премьеры.
              </p>
              <p class="otstup"  id="root">СЭЙЮ И ПЕРСОНАЖИ: <br>
                Yumiri Hanamori в роли Саюри Акино  <br>
                Reina Ueda в роли Рэны Нацукава <br>
                Так же ранее были представлены: <br>
                Аянэ Сакура в роли Минами Фуюки <br>
                Nobunaga Shimazaki в роли Tsubasa Shiki <br>
              </p>

            
              <img class="img-fluid" src="/img/blog/giru/809_o.jpg" alt="">
              
              <p class="otstup"  id="root">Трансляция запланирована январь 2024 года.
              </p>

              <img class="img-fluid" src="/img/blog/giru/810_o.jpg" alt="">
              
              
              <figure class="wp-block-embed">
                <iframe width="730" height="411" src="https://www.youtube.com/embed/3qDvTdBTUww?si=8PbVEi3IGDbh-x4X" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
              
              </figure>
              
              
              
              <img class="img-fluid" src="/img/blog/giru/811_o.jpg" alt="">
              <img class="img-fluid" src="/img/blog/giru/812_o.jpg" alt="">
