...
<head>
 ...
 <meta name="keywords" content="новый сезон аниме, лагерь на свежем воздухе, премьера, «Yuru Camp△», 2024 год"/>
  


  <title>Третий сезон аниме-адаптации манги «Yuru Camp△» стартует в 2024 году</title>
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          ...
          <div class="main_blog_details">
              ...
              <a href="#"><h4>Третий сезон аниме-адаптации манги «Yuru Camp△» стартует в 2024 году</h4></a>
              ...
              <p class="otstup"  id="root">Так же стало известно, что аниме сменит студию: ранее производством сериала занималась C-Station. Теперь будут 8bit. Вместе со студией сменился и персонал.
              </p>
              <p class="otstup"  id="root">ПЕРСОНАЛ: <br>
                Режиссёр: Shin Tosaka<br>
                Компоновка серий: Масафуми Сугиура<br>
                Дизайн персонажей: Hisanori Hashimoto<br>
                Композитор: Akiyuki Tateyama<br>
                Звукорежиссёр: Takeshi Takadera<br>
              </p>
              <img class="img-fluid" src="/img/blog/lager.jpg" alt="">
          ...
          <div class="widget-wrap">
            ...
            <div class="single-sidebar-widget popular-post-widget" id="navbarSupportedContent">
              ...
              <div class="popular-post-list">
                ...
                <div class="single-post-list">
                  <div class="thumb">
                    <a href="overlord.php"><div  class="img_wrap2"><img class="img-fluid card-img rounded-0 big-image-button" src="/img/blog/OVERLORD/6.png" alt=""></div></a> 
